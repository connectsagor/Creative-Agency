...
const Carousel = () => {
  return (
    <div className="carousel-main py-5 text-center">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            <div className="row">
              <div className="col-md-4 img-container-carosel">
                <img src={car1} className="d-block w-75" alt="carousel" />
              </div>
              <div className="col-md-4 img-container-carosel">
                <img src={car2} className="d-block w-75" alt="carousel" />
              </div>
              <div className="col-md-4 img-container-carosel">
                <img src={car4} className="d-block w-75" alt="carousel" />
              </div>
            </div>
          </div>
          <div className="carousel-item">
            <div className="row">
              ...
              <div className="col-md-4 img-container-carosel">
                <img src={car5} className="d-block w-75" alt="carousel" />
              </div>
            </div>
          </div>
          <div className="carousel-item">
